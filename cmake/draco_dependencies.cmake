...
# Each variable holds a user's custom path to a local copy of the sources that
# belong to each project that Draco depends on. When paths are empty the build
# will be generated pointing to the Draco git submodules. Otherwise the paths
# specified by the user will be used in the build configuration.
...
# Path to the gulrak/filesystem installation. The path must is to the root of
# the project source tree: it must contain a directory named include.
...
macro(draco_setup_tinygltf)
  ...
  # TODO(tomfinegan): Includes need to be rewritten for this to do anything.
